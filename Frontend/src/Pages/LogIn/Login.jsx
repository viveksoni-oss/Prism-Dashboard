...
export default function Login() {
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-slate-800 pt-[150px] pb-20">
      ...
      <div className="absolute bottom-[-10%] left-[-10%] w-[40vw] h-[40vw] bg-purple-400/30 rounded-full blur-[80px]" />
